...
const Notifications = () => {
  ...
  const [selectedOption, setSelectedOption] = useState(notificationOptions[0]);
  ...
  const notifications = [
    {
      ...
      msg: 'Your item has been delivered. Please check your items before telling the OTP to Rider.',
      read: false,
    },
    {
      id: 2,
